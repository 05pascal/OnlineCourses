...
<head>
    ...
    <title>{{ ($title) ? $title : '' }} - eDecca</title>
      ...
      <!-- waves.css -->
      <link rel="stylesheet" href="{{ asset('dash/assets/pages/waves/css/waves.min.css') }}" type="text/css" media="all">
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material">
                            <div class="text-center">
                                <img src="{{ asset('dash/assets/images/logo.png') }}" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Votre Adresse Mail</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        ...
                                        <div class="col-12">
                                            <div class="checkbox-fade fade-in-primary d-">
                                                <label>
                                                    ...
                                                    <span class="text-inverse">Resté connecter</span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="forgot-phone text-left">
                                                Vous n'avez pas un compte? <a href="auth-reset-password.html" class="text-left f-w-600">Créer</a>
                                            </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            <p class="text-inverse text-left m-b-0">Merci.</p>
                                            <p class="text-inverse text-left"><a href="index.html"><b>Retour à l'accueil</b></a></p>
                                        </div>
                                        <div class="col-md-2">
                                            <img src="{{ asset('dash/assets/images/auth/Logo-small-bottom.png') }}" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="{{ asset('dash/assets/images/browser/chrome.png') }}" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="{{ asset('dash/assets/images/browser/firefox.png') }}" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="{{ asset('dash/assets/images/browser/opera.png') }}" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="{{ asset('dash/assets/images/browser/safari.png') }}" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="{{ asset('dash/assets/images/browser/ie.png') }}" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
<!-- waves js -->
<script src="{{ asset('dash/assets/pages/waves/js/waves.min.js') }}"></script>
